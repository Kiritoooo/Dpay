	...
	<div id="main">
		<div id="head">
            <dl class="alipay_link">
                <a target="_blank" href="/"><span>申请地址</span></a>
            </dl>
        ...
        <form name=alipayment action=epayapi.php method=post target="_blank">
            <div id="body" style="clear:left">
                <dl class="content">
                    ...
                    <dd>
                        <span class="null-star">*</span>
                        <input size="30" name="WIDsubject" value="商品"/>
                        <span>必填
</span>
                    </dd>
                    <dt>付款金额：</dt>
					...
					<dt>支付方式：</dt>
                    <dd>
                        <label><input type="radio" name="type" value="alipay" checked="">支付宝</label>&nbsp;<label><input type="radio" name="type" value="wxpay">微信支付</label>&nbsp;
                    </dd>
