...
class AlipaySubmit {
	...
	function buildRequestParaGetSign($para_temp) {
		//除去待签名参数数组中的空值和签名参数
		$para_filter = paraFilter($para_temp);
		//对待签名参数数组排序
		$para_sort = argSort($para_filter);
	...
	function consolebuildRequestForm($para_temp,$ytype,$method='POST', $button_name='正在跳转') {
		//待请求参数数组
        ...
        $sHtml.= "<input type='hidden' name='ytype' value='".$ytype."'/>";
